  ...
  return (
    ...
    >
      ...
      <div className="pt-4 pb-5 px-4 flex flex-col flex-1">
        ...
        <h3 style={DF} className="text-[18px] md:text-[20px] font-bold text-[#11311e] leading-tight tracking-wide uppercase mb-1">
          {product.name}
        </h3>
        <p className="text-[11px] md:text-[12px] text-[#6b7462] mb-1.5">{product.sub}</p>
        <p style={DF} className="text-[15px] font-bold text-[#11311e] mb-4 mt-auto">{product.price}</p>
        ...
        <button
          ...
          className={`w-full text-[10px] font-bold tracking-[0.16em] uppercase py-3.5 border transition-colors cursor-pointer ${
            inInquiry 
              ? "bg-[#11311e] text-white border-[#11311e]" 
              : "border-[#11311e] text-[#11311e] hover:bg-[#11311e] hover:text-white hover:border-[#11311e]"
          }`}
        >
