...
export default function FloatingInquiryCTA({
  ...
  return (
    <div className="fixed bottom-[96px] lg:bottom-6 left-1/2 -translate-x-1/2 z-40 w-full max-w-[calc(100%-48px)] sm:w-auto">
      <div className="bg-[#1c2117] shadow-2xl p-4 flex items-center justify-between gap-6 sm:gap-12">
        <div>
        ...
        <button
          ...
          className="flex items-center gap-2 bg-white text-[#1c2117] text-[11px] font-bold tracking-[0.13em] uppercase px-5 py-3 hover:bg-[#f5f3ec] transition-colors cursor-pointer"
        >
