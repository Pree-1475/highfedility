...
export default function ContactMap() {
  ...
  return (
    <div className="h-full min-h-[500px]">
      ...
      >
        <div className="absolute w-4 h-4 bg-[#1a3b28] rounded-full shadow-[0_0_0_8px_rgba(26,59,40,0.2)]" />
        <div className="relative text-center mt-14 bg-white/90 backdrop-blur px-6 py-4 shadow-xl">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-1.5 mt-3 text-[10px] font-bold tracking-[0.16em] uppercase text-[#1a3b28] border-b border-[#1a3b28] pb-px hover:gap-2 transition-all"
          >
