  ...
  return (
    <section className="bg-white py-24 px-10 border-t border-[rgba(28,33,23,0.06)]">
      <div className="max-w-[1440px] mx-auto grid lg:grid-cols-[1fr_1fr] gap-16 items-center">
        <div className="relative overflow-hidden bg-[#ddd9cf] aspect-square">
          <img src={PH.act2} alt="Coaching Session" className="w-full h-full object-cover" />
        </div>
        <div>
          <SectionLabel n="03" label="Why Train With Us" />
          <h2 style={DF} className="text-[48px] font-black leading-[0.88] tracking-tight text-[#11311e] uppercase mb-8">
          ...
          <ul className="flex flex-col gap-6">
            {[
              ...
              <li key={i}>
                <h4 className="text-[14px] font-bold tracking-[0.1em] uppercase text-[#11311e] mb-1">{item.t}</h4>
                <p className="text-[13px] leading-relaxed text-[#6b7462]">{item.d}</p>
              </li>
            ))}
          </ul>
        </div>
