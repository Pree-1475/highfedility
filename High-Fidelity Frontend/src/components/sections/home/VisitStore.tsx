...
export default function VisitStore({ data }: VisitStoreProps) {
  ...
  const renderedTitle = titleText.split("\n").map((line: string, idx: number) => {
    ...
    if (isHighlight) {
      return <span key={idx} className="text-foreground">{line}<br /></span>;
    }
  ...
  return (
    <section id="visit" className="bg-card py-12 md:py-16 lg:py-20 px-10">
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="grid lg:grid-cols-[1fr_1fr] gap-16 items-start">
          <div>
            <h2
              style={DF}
              className="text-[52px] font-black leading-[0.88] tracking-tight text-foreground uppercase mb-10"
            >
              {renderedTitle}
            </h2>
            ...
            <div className="flex gap-4 mb-10">
              <PhoneIcon size={18} className="text-foreground shrink-0 mt-0.5" />
              <div>
                <p className="text-[10px] font-bold tracking-[0.2em] uppercase text-muted-foreground mb-1.5">
                  Phone
                </p>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2.5 border border-[rgba(28,33,23,0.2)] text-foreground text-[11px] font-bold tracking-[0.13em] uppercase px-7 py-4 hover:border-foreground transition-colors duration-200"
              >
                <MapPin size={14} />
                Get Directions
              </a>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div
              className="relative h-44 bg-secondary flex items-center justify-center overflow-hidden"
              style={{
                backgroundImage:
            ...
            >
              <div className="absolute w-3 h-3 bg-foreground rounded-full shadow-[0_0_0_6px_rgba(28,33,23,0.2)]" />
              <div className="relative text-center mt-10">
                <p
                  style={DF}
                  className="text-[18px] font-bold text-foreground uppercase tracking-wide"
                >
                  MR.WILLOW Cricket Store
                </p>
                <p className="text-[12px] text-muted-foreground mt-0.5">Johor Bahru, Malaysia</p>
                <a
                  href={directionsLink}
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-1.5 mt-3 text-[10px] font-bold tracking-[0.16em] uppercase text-foreground border-b border-foreground pb-px"
                >
